...
def build(args):
    class Net(nn.Module):
        def __init__(
            ...
            print("使用英文预训练模型")
            self.preprocessor.load_convert_checkpoint("/home/zyliu/project/FreeVC/wav2vec2.0/w2v_large_lv_fsh_swbd_cv_ftls960_updated.pt")
            ...
            class VQLayer(nn.Module):
                def __init__(this):
                    super().__init__()
                    this.quant = sann.VectorQuantizerEMA(
